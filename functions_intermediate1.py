...
# 2. Iterate Throufh a List of Dictionaries:
...
def iterateDictionary2(key_name, names):
...
traveling = {
    'cities': ['Austin', 'Charlotte', 'New York', 'New Orleans'],
    'visited': ['Austin', 'Charlotte', 'New York']
}
def printInfo(dict):
    for key in dict:
